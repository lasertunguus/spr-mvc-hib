...
<p>Here you can edit the existing organization.</p>
<p>${message}</p>
<form:form method="POST" commandName="organization" action="${pageContext.request.contextPath}/org/edit/${organization.id}.html">
<table>
<tbody>
	<tr>
		<td>Name:</td>
