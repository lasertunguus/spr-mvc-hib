...
<title>Add team member page</title>
</head>
<body>
	...
	<!-- /.container-fluid --> </nav>
<h1>Add team member page</h1>
<p>Here you can add a new team member.</p>
<form:form method="POST" commandName="teamMember" action="${pageContext.request.contextPath}/team_member/add.html">
<table>
<tbody>
	<tr>
		<td>First name:</td>
